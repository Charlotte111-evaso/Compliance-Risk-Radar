        ...
        <div className="container mx-auto max-w-4xl px-4 py-8 space-y-12">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              ...
              capabilities built with Python and deployed on Render.
            </p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600 max-w-lg mx-auto">
                    Access the interactive Python dashboard for real-time fraud detection, anomaly analysis, and
                    geographic risk visualization hosted on Render.
                  </p>
                </div>
                <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg" asChild>
                  <a href="https://compliance-risk-radar4.onrender.com" target="_blank" rel="noopener noreferrer">
