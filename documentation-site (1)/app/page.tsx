          ...
          <Card className="border-gray-200">
            ...
            <CardContent>
              <p className="text-gray-700 leading-relaxed">
                Compliance Risk Radar simulates Binance-style compliance risk detection using Python, Streamlit, pandas,
                and scikit-learn. The system processes user transaction data to identify potential fraud patterns
                through machine learning algorithms, providing real-time risk assessment and anomaly detection
                capabilities for financial compliance teams.
              </p>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    Explore the live Streamlit dashboard with real-time data visualization and filtering capabilities.
                  </p>
